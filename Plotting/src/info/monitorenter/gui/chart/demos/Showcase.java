...
extends JApplet {
	...
	extends JPanel {
		...
		private void createAmountPointSlider() {
			// amountPointsSlider
			this.m_amountPointsSlider = new JSlider(10, 10000);
		...
		private void createLatencySlider() {
			// Latency slider:
			this.m_latencyTimeSlider = new JSlider(1, 210);
	...
	public void init() {
		...
		this.setCollector(new STMCollector(this.getTrace(), 1));
	 ...
	 */
	private void setCollector(final ADataCollector collector) {
